...
#
$LATEX = '/sw/bin/latex';	# LaTeX
$DVIPS = '/sw/bin/dvips';	# dvips
...
#    "../icons".
#
$ICONSERVER = ''||'file:/sw/share/lib/latex2html/icons';
$ALTERNATIVE_ICONS = 0;
...
#
$TEXEXPAND = "$PERL /sw/bin${dd}texexpand";


# Location of pstoimg, supplied with the translator
#
$PSTOIMG = "$PERL /sw/bin${dd}pstoimg";
...
#
$RGBCOLORFILE = '/sw/share/lib/latex2html/styles/rgb.txt';

# the CMYK colors database
#
$CRAYOLAFILE = '/sw/share/lib/latex2html/styles/crayola.txt';
...
$PNMCUT = '/sw/bin/pnmcut';
$PNMFLIP = '/sw/bin/pnmflip';
$PNMPAD = '/sw/bin/pnmpad';
$PNMROTATE = '/sw/bin/pnmrotate';
$PNMSCALE = '/sw/bin/pnmscale';

$GIFTOPNM = '/sw/bin/giftopnm';
$JPEGTOPNM = '/sw/bin/jpegtopnm';
$PNGTOPNM = '/sw/bin/pngtopnm';
$PNMTOPNG = '/sw/bin/pnmtopng';
$PPMTOGIF = '/sw/bin/ppmtogif';
$PPMTOJPEG = '/sw/bin/ppmtojpeg';

# there are for some lesser-used (platform-specific ?) graphics formats:
$TIFFTOPNM = '/sw/bin/tifftopnm';
$ANYTOPNM = '/sw/bin/anytopnm';
$BMPTOPPM = '/sw/bin/bmptoppm';
$PCXTOPPM = '/sw/bin/pcxtoppm';
$PICTTOPPM = '/sw/bin/picttoppm';
$SGITOPNM = '/sw/bin/sgitopnm';
$XBMTOPBM = '/sw/bin/xbmtopbm';
$XWDTOPNM = '/sw/bin/xwdtopnm';
